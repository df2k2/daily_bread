...
- pt: { title, story, lesson, tags } in Brazilian Portuguese (pt-BR)
...
- tags: 3-6 short single-word or two-word topical tags (lowercase, no punctuation).
  Use natural-language tags that a reader might browse by — e.g.
  English: "hope", "anxiety", "prayer", "forgiveness", "trust"
  Português: "esperança", "ansiedade", "oração", "perdão", "confiança"
